...
if __name__ == '__main__':
    ...
    if os.path.isfile("3_houses_momentum_sgd.csv"):
        predictions = load_csv("3_houses_momentum_sgd.csv")
    else:
        sys.exit("Error: missing 0_houses_gd.csv in the current directory.")
